...
//static NSString *const kReceiverAppID = @"kGCKMediaDefaultReceiverApplicationID";  //Replace with your app id
...
- (void)deviceManagerDidConnect:(GCKDeviceManager *)deviceManager {
  ...
  if(!self.isReconnecting) {
    ...
    [self.deviceManager joinApplication:kGCKMediaDefaultReceiverApplicationID sessionID:lastSessionID];
  }
...
- (void)updateToolbarStateIn:(UIViewController *)viewController {
  ...
  if (self.isPlayingMedia) {
    viewController.navigationController.toolbarHidden = NO;
      ...
      viewController.navigationController.toolbar.frame = CGRectMake(0, [[UIScreen mainScreen] bounds].size.height - 44, [[UIScreen mainScreen] bounds].size.width, 44);
